...
#define CUU(N)		printf("\x1b[%d", N )			// Cursor Up
#define CUD(N)		printf("\x1b[%d", N )			// Cursor Down
#define CUF(N)		printf("\x1b[%d", N )			// Cursor Forward
#define CUB(N)		printf("\x1b[%d", N )			// Cursor Back
